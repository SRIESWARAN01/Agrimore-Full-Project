// lib/screens/admin/marketing/widgets/coupon_card.dart
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // Coupon Code Row with copy option
                  Row(
                    ...
                    children: [
                      ...
                      if (coupon.maxDiscountAmount != null)
                        _buildInfoChip(
                          ...
                          label: 'Max ₹${coupon.maxDiscountAmount!.toStringAsFixed(0)}',
                          color: Colors.orange,
                        ),
                    ],
                  ),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      _buildStatItem(Icons.people, 'Used', '${coupon.usedCount}', Colors.blue),
                      _buildStatItem(Icons.inventory_2_rounded, 'Remaining',
                          coupon.usageLimit > 0 ? '${coupon.usageLimit - coupon.usedCount}' : '∞', Colors.green),
                      _buildStatItem(Icons.calendar_today_rounded, 'Days Left',
                          daysUntilExpiry > 0 ? '$daysUntilExpiry' : '0', Colors.orange),
                    ],
                  ),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              color: coupon.isActive ? Colors.green : Colors.orange,
                              fontWeight: FontWeight.w600,
                            ),
                          ),
                        ],
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            isExpired
                                ? 'Expired on ${_formatDate(coupon.validTo)}'
                                : 'Expires on ${_formatDate(coupon.validTo)}',
                            style: AppTextStyles.bodySmall.copyWith(
                              color: isExpired
                                  ? Colors.red.shade700
                                  : daysUntilExpiry < 7

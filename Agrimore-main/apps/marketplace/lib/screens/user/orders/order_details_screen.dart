...
class _OrderDetailsScreenState extends State<OrderDetailsScreen>
  ...
  // ✅ NEW: Track Live Button with ETA for active orders
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            icon: Icon(
              isActive ? Icons.location_on_rounded : Icons.map_rounded,
              size: 18,
            ),
            label: Text(isActive ? 'Track Live' : 'View Tracking'),
            style: ElevatedButton.styleFrom(
              backgroundColor: isActive ? accentColor : (isDark ? const Color(0xFF2C2C2C) : Colors.grey[100]),
              foregroundColor: isActive ? (isDark ? Colors.black : Colors.white) : (isDark ? Colors.white : Colors.black87),
              padding: const EdgeInsets.symmetric(vertical: 14),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(12),
              ),
              elevation: isActive ? 4 : 0,
              shadowColor: isActive ? accentColor.withValues(alpha: 0.3) : Colors.transparent,
            ),
          ),
        ),
      ],

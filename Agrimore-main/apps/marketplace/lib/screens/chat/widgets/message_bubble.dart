            ...
            child: Column(
              ...
              children: [
                ...
                if (message.hasProducts) ...[
                  const SizedBox(height: 10),
                  _buildProductsList(context, message),
                ],
...
Widget _buildMessageContent(
  ...
  if (message.isUser) {
    // USER MESSAGE - solid dark green with white text
    bubbleColor = const Color(0xFF2E7D32); // Solid green, no gradient
    ...
    child: Column(
      ...
      children: [
        ...
        if (message.isAI || message.isError)
          ...
          // USER MESSAGE - explicit white text, no theme dependency
          Text(
            message.text,
...
Widget _buildProductsList(BuildContext context, ChatMessage message) {
  return SizedBox(
    height: 220,

...
class SharedPreferencesService {
  ...
  // GET INSTANCE
  // ============================================
  static SharedPreferences? get _safeInstance {
    return _preferences;
  }
  ...
  static SharedPreferences get instance {
    if (_preferences == null) {
      if (kIsWeb) {
        // On web, during instant start, don't crash - return null check at usage site
        // This is tricky because existing code expects non-null. 
        // Better to throw but only if absolutely needed, or handle in methods.
        // Actually, we should check _preferences in each method.

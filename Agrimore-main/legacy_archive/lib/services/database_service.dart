...
import '../models/order_status.dart'; // This import seems unused, but kept from original
import '../models/user_model.dart'; // ✅ NEW: Added for getUserProfile
...
class DatabaseService {
  ...
  Future<List<CategoryModel>> getAllCategories() async {
    try {
      ...
      // ✅ ENHANCED: Use Firestore ordering.
      // ⚠️ This requires a composite index in Firestore:
      // Collection: 'categories', Fields: [isActive: Ascending, displayOrder: Ascending]
      final snapshot = await _firestore
      ...
      if (e.toString().contains('FAILED_PRECONDITION')) {
        debugPrint(
            '🔥 FIRESTORE INDEX REQUIRED! Check the console log for a link to create the index for the "categories" collection.');
      }

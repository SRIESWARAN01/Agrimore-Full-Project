      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            if (_isCheckingPurchase || !_hasPurchased)
              Positioned.fill(
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(20),
                      ...
                      child: Center(
                        child: _isCheckingPurchase
                            ...
                            : Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(Icons.lock_outline_rounded, size: 40, color: isDark ? Colors.grey[500] : Colors.grey[600]),
                                  const SizedBox(height: 16),
                                  Text(
                                    'Purchase Required',
                                    style: TextStyle(
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      'You must purchase and receive this item to write a review.',

// lib/screens/user/home/widgets/deals_for_you.dart
...
class _DealsForYouState extends State<DealsForYou> with TickerProviderStateMixin {
          ...
          children: [
            Padding(
              ...
              child: _buildSectionHeader(
                context: context,
                title: 'Deals For You',
                subtitle: 'Top discounts just for you', // Added subtitle
                totalProducts: dealsProducts.length,
                isDark: isDark,
                onSeeAll: () {
                  Navigator.pushNamed(context, AppRoutes.shop, arguments: {'showDeals': true});
                },
              ),
            ),
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemCount: math.min(dealsProducts.length, 8), // Limit to 8
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      '${totalProducts > 8 ? '8+' : totalProducts}', // Show count
                      style: TextStyle(
                        fontSize: 11,

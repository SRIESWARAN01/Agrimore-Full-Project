...
import 'widgets/deals_for_you.dart'; // <-- FIXED
import 'widgets/featured_products.dart';
import 'widgets/recently_viewed_widget.dart'; // <-- ADDED FROM MOBILE
import 'widgets/sponsored_banner.dart'; // <-- ADDED FROM MOBILE
import 'widgets/trending_products.dart'; // <-- ADDED FROM MOBILE
...
class _WebHomeScreenState extends State<WebHomeScreen>
  ...
  void _loadData() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      // Keep web's more complex data load
      ...
      body: RefreshIndicator(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            // 3. Sponsored Banner (from mobile)
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 40),
                child: _buildSectionWrapper(
            ...
            // 4. Deal of the Day (fixed)
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 40),
                child: _buildSectionWrapper(
                  child: const DealsForYou(), // <-- FIXED
                ),
              ),
            ),
            ...
            // 5. Trending Now (from mobile)
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 40),
                child: _buildSectionWrapper(
                  child: const TrendingProducts(), // <-- REPLACED INLINE METHOD
                ),
              ),
            ),
